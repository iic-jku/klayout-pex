...
T {Result: C1 capacitance is 11.39fF

(instead using ideal capacity of 11.39f we'd get 11.41f)} 600 -510 0 0 0.25 0.25 { layer=7}
N 100 -590 120 -590 {
lab=vin}
N 260 -590 440 -590 {
lab=vout}
...
.endc
"}
C {sky130_fd_pr/vpp_cap.sym} 280 -560 0 0 {name=C1
model=cap_vpp_04p4x04p6_l1m1m2_noshield
W=1
L=1
mult=1 
spiceprefix=X}
