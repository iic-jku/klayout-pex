...
T {(using ideal capacity of 144.94f we get 145.28f)} 600 -510 0 0 0.25 0.25 { layer=7}
N 100 -590 120 -590 {
lab=vin}
N 260 -590 440 -590 {
lab=vout}
...
"
spice_ignore=false}
C {devices/capa.sym} 300 -560 0 0 {name=C2
m=1
value=144.94f
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 300 -530 0 0 {name=l2 lab=GND}
